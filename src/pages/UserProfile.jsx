...
import { FaBell, FaCalendarAlt, FaCamera, FaCog, FaCreditCard, FaEdit, FaEnvelope, FaHeart, FaMapMarkerAlt, FaPhone, FaShoppingBag, FaSignOutAlt, FaUser } from 'react-icons/fa';
...
// }, [])
  ...
  const [userInfo, setUserInfo] = useState({
    ...
    bio: 'Passionate about technology and design. Love exploring new places and trying different cuisines.',
  ...
  const recentOrders = [
    { id: '#12345', date: '2 days ago', status: 'Delivered', amount: '$145.00' },
    { id: '#12344', date: '1 week ago', status: 'Processing', amount: '$89.50' },
    { id: '#12343', date: '2 weeks ago', status: 'Delivered', amount: '$210.00' }
  ];
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              <div className="text-center mb-6">
                ...
                <h2 className="text-xl font-semibold text-black mb-1">{userInfo.name}</h2>
          ...
          <div className="lg:col-span-3">
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                {/* Recent Orders */}
                <div className="bg-white rounded-lg shadow-sm p-6">
                  <h3 className="text-xl font-semibold text-black mb-6">Recent Orders</h3>
                  <div className="space-y-4">
                    {recentOrders.map((order) => (
                      <div key={order.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
                            <FaShoppingBag size={20} className="text-gray-600" />
                          </div>
                          <div>
