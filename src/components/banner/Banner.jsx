...
const Banner = () => {
  return (
    <div className='banner text-center md:text-left bg-cover bg-no-repeat md:bg-center bg-left font-secondary relative md:pt-[199px] pt-[100px] pb-[116px]'>
      <Container>
    ...
    <img src={bannerImg} className=' w-[80%] ml-auto' alt="" />
          </div>
        </Flex>
      </Container>
